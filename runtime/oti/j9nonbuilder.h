...
#define J9VM_CRIU_IS_FULL_SECURITY_ENV_ENABLED 0x3
...
#define J9VM_CRIU_DISABLE_CRIU_SEC_PROVIDER 0x40
...
typedef struct J9InternalVMFunctions {
	...
	BOOLEAN (*disableCRIUSecProvider)(struct J9VMThread *currentThread);
